...
function cleanDist(done) { // wywołaj funckcję recznie => gulp cleanSrc
...
function watchForChanges(done) {
	...
	watch([paths.html, paths.sass, paths.js], 
	parallel(handleKits, sassCompiler, javaScript)).on('change',reload);
